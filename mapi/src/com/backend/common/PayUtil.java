...
public class PayUtil {
    ...
    private static String appid = "wx3f315fb4a4971eb9";  //小程序ID
    private static String secret = "e7084d91bead78acebbd3cfe3f025040";
    private static String mch_id = "1481599512";  //商户号
    private static String body = "Yoyo-游友科技-"; //Yoyo-游友科技-
    ...
    public String returnOrderNumb() {
        ...
        String charString = new PayUtil().generateString(5);
    ...
    private static String getXmlInfo(String payClass, String payMoney, String orderNumb, String orderTime, String openid, String ipString) throws Exception {
        ...
        String nonce_str = new PayUtil().generateString(24);
        String sign = new PayUtil().returnSign(nonce_str, body+payClass, orderNumb, openid, payMoney, orderTime, trade_type, ipString);
        sb.append("<xml>");
